    ...
    public static class GameSupport
    {
        ...
        public static void PrQuestUX2ndPacket()
        {
            ...
            using (OutPacket outPacket = new OutPacket("PrQuestUX2ndPacket"))
            {
                ...
                //questGroupIndex='1'
                outPacket.WriteInt(115002301);
                outPacket.WriteInt(115002301);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(115002302);
                outPacket.WriteInt(115002302);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(115002303);
                outPacket.WriteInt(115002303);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                //questGroupIndex = '2'
                outPacket.WriteInt(215010013);
                outPacket.WriteInt(215010013);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(215020019);
                outPacket.WriteInt(215020019);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(215030021);
                outPacket.WriteInt(215030021);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(215040015);
                outPacket.WriteInt(215040015);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                //questGroupIndex='3'
                outPacket.WriteInt(315010001);
                outPacket.WriteInt(315010001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(315020002);
                outPacket.WriteInt(315020002);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(315030003);
                outPacket.WriteInt(315030003);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(315040004);
                outPacket.WriteInt(315040004);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                RouterListener.MySession.Client.Send(outPacket);
            }
